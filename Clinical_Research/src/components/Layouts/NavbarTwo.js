        ...
        <div className="evolta-nav">
          <div className="container">
            <nav className="navbar navbar-expand-md navbar-light flex items-center justify-between">
              ...
              {/* Navbar Links */}
              <div className={`absolute md:static top-16 left-[-12px]  w-screen mt-[-7px] bg-white md:flex md:items-center md:space-x-6 px-4 md:px-0 ${menuOpen ? "block" : "hidden"}`}>
                <ul className="navbar-nav space-y-4 sm:mt-0  md:space-y-0 md:flex md:space-x-6">
                  {[
                    { path: "/", label: "Home" },
