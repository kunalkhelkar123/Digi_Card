    ...
    return (
        ...
        <div id="contact-us" className="ContactDetail pt-12 pb-12 bg-blue-800 text-white ">
            ...
            <div className="container mx-auto px-4  flex flex-col justify-center align-top">
                ...
                {/* Padding for the top section */}
                <div className="PaddingTop">
                    {/* Flex container for organizing content side by side on medium screens */}
                    <div className="flex flex-col md:flex-row md:space-x-8">
                            ...
                            <div className="LeftSide">
                                ...
                                <ul className="Listing space-y-4">
                                    ...
                                    <li className="flex items-start">
                                        <i className="fas fa-map-marked-alt text-white mr-2"></i>
                                        <span>
                                            DigiSwipe: Your Digital Card Always
                                            <span className="block">By VJanalytics Private Limited Pune</span>
                                            <span className='block'>Office Number 203, Mont Vert Spectra</span>
                                        </span>
                                    </li>
